...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/VEIGAEST_myeloidcells_clustering_level2_myeloidcells.rds"))
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/VEIGAEST_biomarkers_level3_myeloidcells_res0.5.xlsx"))
```
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "Myeloid cells - level3")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/VEIGAEST_clustering_level3_myeloidcells_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2", "annot_level3")],
        paste0(path_r_objects, "/VEIGAEST_myeloidcells_annotation_level3.rds"))
```
...
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/VEIGAEST_myeloidcells_clustering_level3_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/VEIGAEST_myeloidcells_clustering_level3_annotation.rds"))
```
