...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/VEIGAEST_NKcells_clustering_level2_annotation.rds"))
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/VEIGAEST_biomarkers_level3_NKcells_res0.5.xlsx"))
```
...
ILC1_genes <- c("Tbx21", "Il7r", "Ltb", "Rgs1", "Tnsf10", "Cxcr3", "Cd160", "S100a4", "Ly6e", "Itga1", "Cxcr6", "Xcl1", "Cd7")  
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  "0" = "CD27+CD11b- NK cells",
  "1" = "CD27-CD11b+ NK cells",
  "2" = "CD27+CD11b- NK cells",
  "3" = "ILC1",
  "4" = "IFN-responder NK cells",
  "5" = "NKT cells",
  "6" = "Cycling NK cells"
)
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "NK cells - level3")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/VEIGAEST_clustering_level3_NKcells_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2", "annot_level3")],
        paste0(path_r_objects, "/VEIGAEST_NKcells_annotation_level3.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/VEIGAEST_NKcells_clustering_level3_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/VEIGAEST_NKcells_clustering_level3_annotation.rds"))
```
