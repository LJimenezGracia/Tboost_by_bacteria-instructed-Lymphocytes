...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/VEIGAEST_neutrophils_clustering_level2_annotation_neutrophils.rds"))
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/VEIGAEST_biomarkers_level3_neutrophils_res0.25.xlsx"))
```
...
N1_genes <- c("Ccr5", "Gnb1", "Stat2", "Jak2", "Jak3", "Rac1", "Rac2",
              ...
              "Ccl3", "Ccl7", "Cxcl3", "Cxcl4", "Cxcl9", "Cxcl10", "Ccl6"," Cxcl13", "Icam1", "Ifit1", "Ifit3")
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "Neutrohils - level3")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/VEIGAEST_clustering_level3_neutrophils_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2", "annot_level3")],
        paste0(path_r_objects, "/VEIGAEST_neutrophils_annotation_level3.rds"))
```

## Remove uninteres
# Save processed Seurat objects
```{r}
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/VEIGAEST_neutrophils_clustering_level3_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/VEIGAEST_neutrophils_clustering_level3_annotation.rds"))
```
