---
title: "Clustering & Annotation - NK cells"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/VEIGAEST_clustering_level1_NKcells.rds"))
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/VEIGAEST_biomarkers_level2_NKcells_res0.5.xlsx"))
```
...
```{r fig.width=14, fig.height=15}
NK1_NKCD27posCD11bneg <-c("Cd27", "Itgam", "Ctla2a", "Emb", "Ccr2", "Socs3", "Xcl1", "Cd7", "Cd7", "Gnb2l1", "Shisa5", "Ltb",
                         "Cd28", "Sell", "S1pr1", "Ly6e", "Thy1", "P2ry10")
# Equivalent to CD56bright
FeaturePlot(seurat_obj_integrated,
            features = NK1_NKCD27posCD11bneg,
            #split.by = "tissue",
            pt.size = 0.25,
            ncol = 3
)
...
NK2_CD27negCD11bpos <- c("Cd27", "Itgam", "Gzmb", "Klrg1", "Ly6c2", "Cma1", "Klra9", "Ncr1", "Emp3", "Fgl2", "Pdia6", "Zeb2",
                           "Prf1", "Ccl4", "Calr", "Cst7", "Kcnj8", "Itgb2", "Spn") 
# Equivalent to CD56dim
FeaturePlot(seurat_obj_integrated,
            features = NK2_CD27negCD11bpos,
            #order = TRUE,
            #split.by = "tissue",
            pt.size = 0.25,
            ncol = 5
...
NKT_genes <- c("Cd3e", "Cd3d", "Il7r", "Ncam1", "Klrb1", "Fcgr3", "Xcl1", "Xcl2", "Klrg1")  
...
ILC_genes <- c("Gata3", "Rora", "Il7r", "Maf", "Rorc", "Znf683", "Tbx21",  "Ccr6", "Irf4", "Eomes", "Ikzf3", "Icos")  
...
```{r fig.width=20, fig.height=10}
IFN_NK_genes <- c("Ifng", "Ifi209", "Ifi206", "Ifit2", "Ifit3", "Isg15")

FeaturePlot(seurat_obj_integrated,
            features = IFN_NK_genes,
            label = T,
            #split.by = "tissue",
            order = F,
            pt.size = 0.25,
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  "0" = "NK cells", # CD27+CD11b- NK cells
  "1" = "NK cells", # CD27-CD11b+ NK cells
  "2" = "NK cells", # ILC2
  "3" = "NK cells", # CD27+CD11b- NK cells
  "4" = "LowQuality_cells",
  "5" = "NK cells", # IFN+ NK cells
  "6" = "NK cells", # NKT cells
  "7" = "NK cells", # Cycling NK cells
  "8" = "Doublets"
)
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "NK cells - level2")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/VEIGAEST_clustering_level2_NKcells_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2")],
        paste0(path_r_objects, "/VEIGAEST_NKcells_annotation_level2.rds"))
```
...
# Save processed Seurat objects
```{r}
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/VEIGAEST_NKcells_clustering_level2_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/VEIGAEST_NKcells_clustering_level2_annotation.rds"))
```
...
ggsave(filename = paste0(path_r_figs, "/VEIGAEST_clustering_level2_NKcells_annotation_clean_umap.png"),
       plot = gg_umap_clustering_annot)
```
