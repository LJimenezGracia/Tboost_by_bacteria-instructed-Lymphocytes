...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/VEIGAEST_clustering_level1_myeloidcells.rds"))
...
Idents(seurat_obj_integrated) <- "RNA_snn_res.0.1"
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/VEIGAEST_biomarkers_level2_myeloidcells_res0.1.xlsx"))
```
...
pDC <- c("Siglech", "Clec4c", "Lilrb4", "Nrp1", "Ccr7", "Cd86", "Ly6d", "Igkc", "Bst2", "Irf8")
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  "0" = "Myeloid cells",
  "1" = "Doublets",
  "2" = "Myeloid cells", # mono
  "3" = "Myeloid cells", #  macro
  "4" = "Myeloid cells", # DC
  "5" = "Myeloid cells", # DC
  "6" = "pDCs"
)
...
ggsave(filename = paste0(path_r_figs, "/VEIGAEST_clustering_level2_myeloidcells_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2")],
        paste0(path_r_objects, "/VEIGAEST_myeloidcells_annotation_level2.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/VEIGAEST_myeloidcells_clustering_level2_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/VEIGAEST_myeloidcells_clustering_level2_annotation.rds"))
```
...
ggsave(filename = paste0(path_r_figs, "/VEIGAEST_clustering_level2_myeloidcells_annotation_clean_umap.png"),
       plot = gg_umap_clustering_annot)
```
...
```{r}
# Myeloid cells
seurat_obj_myeloid <- subset(seurat_obj_integrated, idents = "Myeloid cells")
saveRDS(seurat_obj_myeloid, paste0(path_r_objects, "/VEIGAEST_myeloidcells_clustering_level2_annotation_myeloidcells.rds"))
