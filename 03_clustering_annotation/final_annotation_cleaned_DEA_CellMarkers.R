...
saveRDS(seurat_obj_markers,
        file = paste0(path_r_objects, "/VEIGAEST_annotation_full_cleaned_DEA_CellMarkers.rds"))
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/VEIGAEST_annotation_full_cleaned_DEA_CellMarkers.xlsx"))
